//! Кости. Модель НИКОГДА не бросает сама — она только объявляет проверку (характеристика
//! + сложность) или атаку, а бросок делает сервер на криптостойком генераторе. Так результат
//! честный, и нарратор не может выдумать себе итог.
