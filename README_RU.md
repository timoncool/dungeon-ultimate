...
<table>
<tr>
<td width="50%" valign="top"><img src="./docs/modal.png" alt="Создание истории" /><br /><sub><b>Старт новой истории</b> — выбери жанр, скажи, кто ты, и рассказчик напишет завязку.</sub></td>
<td width="50%" valign="top"><img src="./docs/prose.png" alt="Режим повествования" /><br /><sub><b>Чистое повествование</b> — проза рассказчика течёт слово за словом, как в книге.</sub></td>
</tr>
</table>
</div>
