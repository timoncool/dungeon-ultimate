...
export type SettingsText = {
  ...
  // Остатки текста из кода (ревью 2026-09): сообщения, кнопки, подсказки
  modelFolderOpenedAt: string;
  clipNotPlayed: string;
  narratorTimedOut: string;
  portraitOf: string;
  emptyStoryHint: string;
  whatDoYouDo: string;
  createNewStory: string;
  fill: string;
  add: string;
  auto: string;
  willBeRemovedFromStory: string;
  builtInModel: string;
  ...
  apiKey: string;
  customServerNote: string;
  speechRateNote: string;
  voiceInput: string;
  ...
  founderOf: string;
  neuroSoft: string;
  clearLocalDataWarning: string;
  chatWillBeDeleted: string;
  charactersTab: string;
  dataTab: string;
  customWorldPlaceholder: string;
  openingPlaceholder: string;
  nameExampleHero: string;
  nameExampleCharacter: string;
};
...
const RU: SettingsText = {
  ...
  modelFolderOpenedAt: "Папка модели открыта: {path}",
  clipNotPlayed: "Клип не проигрался: {reason}",
  narratorTimedOut: "Рассказчик слишком долго отвечал. Модель ещё может работать в фоне; подожди немного, затем повтори или перезапусти локальную модель, если система под нагрузкой.",
  portraitOf: "{name} (портрет)",
  emptyStoryHint: "Начни историю и опиши, что ты делаешь — дальше рассказчик подхватит, со сценами и всем остальным.",
  whatDoYouDo: "Что ты делаешь?",
  createNewStory: "Создать новую историю",
  fill: "Заполнить",
  add: "Добавить",
  auto: "Авто",
  willBeRemovedFromStory: "{name} будет удалён из этой истории.",
  builtInModel: "Встроенная модель",
  localModelUnavailable: "Встроенная модель не отвечает. Проверь, что она скачана, и перезапусти игру.",
  localModelMissing: "Модель не скачана. Докачай её на экране данных на диске.",
  quickFill: "Быстрое заполнение",
  serverUrl: "URL сервера",
  model: "Модель",
  enteredManually: "(вручную)",
  modelListFailed: "Не удалось получить список моделей с сервера — впиши id вручную.",
  apiKey: "API-ключ",
  customServerNote: "Любой OpenAI-совместимый сервер: llama.cpp, LM Studio, vLLM, TabbyAPI, KoboldCpp, OpenRouter или удалённая Ollama. Всё остаётся на твоей машине, и большинству локальных серверов ключ не нужен. Для OpenRouter вставь id модели с ",
  speechRateNote: "Работает с любым голосом — и своим, и облачным: темп ставит сам проигрыватель, тон не меняется.",
  voiceInput: "Голосовой ввод",
  noAchievementsYet: "Пока пусто. Награды дают за поступок — выстоять против сильнейшего, пощадить побеждённого, пройти сцену без единого удара. Их не выпрашивают: они случаются.",
  xpReward: "+{n} опыта",
  from: "от:",
  reward: "награда:",
  item: "Предмет",
  computesOn: "Считает:",
  check: "Проверить",
  deleteAllLocalData: "Удалить все локальные данные",
  supportBlurb: "Dungeon Ultimate — бесплатный проект с открытым исходным кодом от Nerual Dreming и Нейро-Софт. Если он нашёл место на твоей машине, поддержка помогает делать новые портативные нейросети.",
  madeBy: "Сделал",
  founderOf: "— основатель",
  neuroSoft: "Нейро-Софт",
  clearLocalDataWarning: "Удалит все локальные истории, сообщения, персонажей, загруженные фото, сгенерированные картинки и временные файлы-референсы с этого компьютера.",
  chatWillBeDeleted: "{title} и его сохранённые сообщения будут удалены из локальной базы.",
  charactersTab: "Персонажи",
  dataTab: "Данные",
  customWorldPlaceholder: "Ты — смотритель маяка на побережье, где туман начал шептать в ответ. Прошлой ночью свет погас сам собой...",
  openingPlaceholder: "Дождь барабанит по жестяной крыше остановки. Ты плотнее запахиваешь пальто и снова смотришь на часы. Автобус на 11:40 опаздывает уже на двадцать минут, а единственный кроме тебя человек здесь не сводит с тебя глаз...",
  nameExampleHero: "Алиса Фордринг",
  nameExampleCharacter: "Валери Марото",
};
...
const EN: SettingsText = {
  ...
  modelFolderOpenedAt: "Model folder opened: {path}",
  clipNotPlayed: "The clip did not play: {reason}",
  narratorTimedOut: "The narrator took too long to answer. The model may still be working in the background; wait a moment, then retry or restart the local model if the system is under load.",
  portraitOf: "{name} (portrait)",
  emptyStoryHint: "Start the story and describe what you do — the narrator picks it up from there, scenes and all.",
  whatDoYouDo: "What do you do?",
  createNewStory: "Create a new story",
  fill: "Fill in",
  add: "Add",
  auto: "Auto",
  willBeRemovedFromStory: "{name} will be removed from this story.",
  builtInModel: "Built-in model",
  localModelUnavailable: "The built-in model is not responding. Check that it is downloaded and restart the game.",
  localModelMissing: "The model is not downloaded. Fetch it from the data-on-disk panel.",
  quickFill: "Quick fill",
  serverUrl: "Server URL",
  model: "Model",
  enteredManually: "(manual)",
  modelListFailed: "Could not fetch the model list from the server — type the id by hand.",
  apiKey: "API key",
  customServerNote: "Any OpenAI-compatible server: llama.cpp, LM Studio, vLLM, TabbyAPI, KoboldCpp, OpenRouter, or a remote Ollama. Everything stays on your machine, and most local servers need no key. For OpenRouter, paste a model id from ",
  speechRateNote: "Works with any voice, local or cloud: the player sets the tempo, the pitch stays the same.",
  voiceInput: "Voice input",
  noAchievementsYet: "Nothing yet. Achievements are earned by deeds — standing against the strongest foe, sparing the defeated, getting through a scene without a single blow. They are not asked for: they happen.",
  xpReward: "+{n} XP",
  from: "from:",
  reward: "reward:",
  item: "Item",
  ...
  supportBlurb: "Dungeon Ultimate is a free open-source project by Nerual Dreming and Neuro-Soft. If it has found a place on your machine, your support helps make new portable neural networks.",
  madeBy: "Made by",
  founderOf: "— founder of",
  neuroSoft: "Neuro-Soft",
  clearLocalDataWarning: "This removes every local story, message, character, uploaded photo, generated picture and temporary reference file from this computer.",
  chatWillBeDeleted: "{title} and its saved messages will be removed from the local database.",
  charactersTab: "Characters",
  dataTab: "Data",
  customWorldPlaceholder: "You are a lighthouse keeper on a coast where the fog has started whispering back. Last night the light went out on its own...",
  openingPlaceholder: "Rain hammers the tin roof of the bus shelter. You pull your coat tighter and check the time again. The 11:40 is twenty minutes late, and the only other person here keeps watching you...",
  nameExampleHero: "Alice Fordring",
  nameExampleCharacter: "Valerie Maroto",
};
...
const ES: SettingsText = {
  ...
  modelFolderOpenedAt: "Carpeta del modelo abierta: {path}",
  clipNotPlayed: "El clip no se reprodujo: {reason}",
  narratorTimedOut: "El narrador tardó demasiado en responder. Puede que el modelo siga trabajando en segundo plano; espera un momento y vuelve a intentarlo, o reinicia el modelo local si el sistema está sobrecargado.",
  portraitOf: "{name} (retrato)",
  emptyStoryHint: "Empieza la historia y describe lo que haces: el narrador seguirá desde ahí, con escenas y todo lo demás.",
  whatDoYouDo: "¿Qué haces?",
  createNewStory: "Crear una nueva historia",
  fill: "Rellenar",
  add: "Añadir",
  auto: "Auto",
  willBeRemovedFromStory: "{name} se eliminará de esta historia.",
  builtInModel: "Modelo integrado",
  localModelUnavailable: "El modelo integrado no responde. Comprueba que esté descargado y reinicia el juego.",
  localModelMissing: "El modelo no está descargado. Descárgalo desde el panel de datos en disco.",
  quickFill: "Relleno rápido",
  serverUrl: "URL del servidor",
  model: "Modelo",
  enteredManually: "(manual)",
  modelListFailed: "No se pudo obtener la lista de modelos del servidor: escribe el id a mano.",
  apiKey: "Clave API",
  customServerNote: "Cualquier servidor compatible con OpenAI: llama.cpp, LM Studio, vLLM, TabbyAPI, KoboldCpp, OpenRouter o una Ollama remota. Todo se queda en tu máquina, y la mayoría de servidores locales no necesitan clave. Para OpenRouter, pega el id de un modelo de ",
  speechRateNote: "Funciona con cualquier voz, propia o en la nube: el ritmo lo pone el reproductor y el tono no cambia.",
  voiceInput: "Entrada por voz",
  noAchievementsYet: "Aún nada. Los logros se ganan con hechos: resistir al enemigo más fuerte, perdonar al vencido, pasar una escena sin un solo golpe. No se piden: ocurren.",
  xpReward: "+{n} PX",
  from: "de:",
  reward: "recompensa:",
  item: "Objeto",
  ...
  supportBlurb: "Dungeon Ultimate es un proyecto gratuito y de código abierto de Nerual Dreming y Neuro-Soft. Si se ha ganado un sitio en tu máquina, tu apoyo ayuda a crear nuevas redes neuronales portátiles.",
  madeBy: "Creado por",
  founderOf: "— fundador de",
  neuroSoft: "Neuro-Soft",
  clearLocalDataWarning: "Eliminará todas las historias, mensajes, personajes, fotos subidas, imágenes generadas y archivos de referencia temporales de este equipo.",
  chatWillBeDeleted: "{title} y sus mensajes guardados se eliminarán de la base de datos local.",
  charactersTab: "Personajes",
  dataTab: "Datos",
  customWorldPlaceholder: "Eres el farero de una costa donde la niebla ha empezado a susurrar de vuelta. Anoche la luz se apagó sola...",
  openingPlaceholder: "La lluvia golpea el techo de chapa de la parada. Te ajustas el abrigo y vuelves a mirar la hora. El de las 11:40 lleva veinte minutos de retraso, y la única otra persona aquí no deja de observarte...",
  nameExampleHero: "Alicia Fordring",
  nameExampleCharacter: "Valeria Maroto",
};
...
const FR: SettingsText = {
  ...
  modelFolderOpenedAt: "Dossier du modèle ouvert : {path}",
  clipNotPlayed: "Le clip n'a pas été lu : {reason}",
  narratorTimedOut: "Le narrateur a mis trop de temps à répondre. Le modèle travaille peut-être encore en arrière-plan ; patiente un instant, puis réessaie ou redémarre le modèle local si le système est surchargé.",
  portraitOf: "{name} (portrait)",
  emptyStoryHint: "Commence l'histoire et décris ce que tu fais : le narrateur prend le relais, scènes comprises.",
  whatDoYouDo: "Que fais-tu ?",
  createNewStory: "Créer une nouvelle histoire",
  fill: "Remplir",
  add: "Ajouter",
  auto: "Auto",
  willBeRemovedFromStory: "{name} sera retiré de cette histoire.",
  builtInModel: "Modèle intégré",
  localModelUnavailable: "Le modèle intégré ne répond pas. Vérifie qu'il est téléchargé et relance le jeu.",
  localModelMissing: "Le modèle n'est pas téléchargé. Récupère-le depuis le panneau des données sur le disque.",
  quickFill: "Remplissage rapide",
  serverUrl: "URL du serveur",
  model: "Modèle",
  enteredManually: "(manuel)",
  modelListFailed: "Impossible de récupérer la liste des modèles : saisis l'identifiant à la main.",
  apiKey: "Clé API",
  customServerNote: "N'importe quel serveur compatible OpenAI : llama.cpp, LM Studio, vLLM, TabbyAPI, KoboldCpp, OpenRouter ou un Ollama distant. Tout reste sur ta machine, et la plupart des serveurs locaux n'ont pas besoin de clé. Pour OpenRouter, colle un identifiant de modèle depuis ",
  speechRateNote: "Fonctionne avec n'importe quelle voix, locale ou cloud : le lecteur règle le tempo, le timbre ne change pas.",
  voiceInput: "Saisie vocale",
  noAchievementsYet: "Rien pour l'instant. Les succès se gagnent par des actes : tenir face au plus fort, épargner le vaincu, traverser une scène sans un coup. On ne les demande pas : ils arrivent.",
  xpReward: "+{n} XP",
  from: "de :",
  reward: "récompense :",
  item: "Objet",
  computesOn: "Calcule sur :",
  check: "Vérifier",
  deleteAllLocalData: "Supprimer toutes les données locales",
  supportBlurb: "Dungeon Ultimate est un projet gratuit et open source de Nerual Dreming et Neuro-Soft. S'il a trouvé sa place sur ta machine, ton soutien aide à créer de nouveaux réseaux de neurones portables.",
  madeBy: "Créé par",
  founderOf: "— fondateur de",
  neuroSoft: "Neuro-Soft",
  clearLocalDataWarning: "Supprime toutes les histoires, messages, personnages, photos importées, images générées et fichiers de référence temporaires de cet ordinateur.",
  chatWillBeDeleted: "{title} et ses messages enregistrés seront supprimés de la base locale.",
  charactersTab: "Personnages",
  dataTab: "Données",
  customWorldPlaceholder: "Tu es gardien de phare sur une côte où la brume s'est mise à chuchoter en retour. La nuit dernière, la lumière s'est éteinte toute seule...",
  openingPlaceholder: "La pluie martèle le toit en tôle de l'abribus. Tu resserres ton manteau et regardes l'heure encore une fois. Le 11 h 40 a vingt minutes de retard, et la seule autre personne ici ne cesse de t'observer...",
  nameExampleHero: "Alice Fordring",
  nameExampleCharacter: "Valérie Maroto",
};
...
const DE: SettingsText = {
  ...
  modelFolderOpenedAt: "Modellordner geöffnet: {path}",
  clipNotPlayed: "Der Clip wurde nicht abgespielt: {reason}",
  narratorTimedOut: "Der Erzähler hat zu lange gebraucht. Das Modell arbeitet womöglich noch im Hintergrund; warte kurz, dann versuche es erneut oder starte das lokale Modell neu, wenn das System ausgelastet ist.",
  portraitOf: "{name} (Porträt)",
  emptyStoryHint: "Beginne die Geschichte und beschreibe, was du tust – der Erzähler übernimmt von dort, mit Szenen und allem.",
  whatDoYouDo: "Was tust du?",
  createNewStory: "Neue Geschichte erstellen",
  fill: "Ausfüllen",
  add: "Hinzufügen",
  auto: "Auto",
  willBeRemovedFromStory: "{name} wird aus dieser Geschichte entfernt.",
  builtInModel: "Eingebautes Modell",
  localModelUnavailable: "Das eingebaute Modell antwortet nicht. Prüfe, ob es heruntergeladen ist, und starte das Spiel neu.",
  localModelMissing: "Das Modell ist nicht heruntergeladen. Hole es über das Panel „Daten auf der Festplatte“.",
  quickFill: "Schnellausfüllen",
  serverUrl: "Server-URL",
  model: "Modell",
  enteredManually: "(manuell)",
  modelListFailed: "Die Modellliste konnte nicht vom Server geladen werden – gib die ID von Hand ein.",
  apiKey: "API-Schlüssel",
  customServerNote: "Jeder OpenAI-kompatible Server: llama.cpp, LM Studio, vLLM, TabbyAPI, KoboldCpp, OpenRouter oder ein entferntes Ollama. Alles bleibt auf deinem Rechner, und die meisten lokalen Server brauchen keinen Schlüssel. Für OpenRouter füge eine Modell-ID ein von ",
  speechRateNote: "Funktioniert mit jeder Stimme, lokal wie in der Cloud: das Tempo setzt der Player, die Tonhöhe bleibt.",
  voiceInput: "Spracheingabe",
  noAchievementsYet: "Noch nichts. Erfolge verdient man sich durch Taten – dem Stärksten standhalten, den Besiegten verschonen, eine Szene ohne einen einzigen Schlag bestehen. Man erbittet sie nicht: sie geschehen.",
  xpReward: "+{n} EP",
  from: "von:",
  reward: "Belohnung:",
  item: "Gegenstand",
  computesOn: "Rechnet auf:",
  check: "Prüfen",
  deleteAllLocalData: "Alle lokalen Daten löschen",
  supportBlurb: "Dungeon Ultimate ist ein kostenloses Open-Source-Projekt von Nerual Dreming und Neuro-Soft. Wenn es einen Platz auf deinem Rechner gefunden hat, hilft deine Unterstützung, neue portable neuronale Netze zu bauen.",
  madeBy: "Gemacht von",
  founderOf: "– Gründer von",
  neuroSoft: "Neuro-Soft",
  clearLocalDataWarning: "Entfernt alle lokalen Geschichten, Nachrichten, Charaktere, hochgeladenen Fotos, erzeugten Bilder und temporären Referenzdateien von diesem Computer.",
  chatWillBeDeleted: "{title} und die gespeicherten Nachrichten werden aus der lokalen Datenbank entfernt.",
  charactersTab: "Charaktere",
  dataTab: "Daten",
  customWorldPlaceholder: "Du bist Leuchtturmwärter an einer Küste, an der der Nebel begonnen hat zurückzuflüstern. Letzte Nacht ging das Licht von allein aus...",
  openingPlaceholder: "Regen prasselt auf das Blechdach der Bushaltestelle. Du ziehst den Mantel enger und schaust wieder auf die Uhr. Der 11:40 hat zwanzig Minuten Verspätung, und die einzige andere Person hier lässt dich nicht aus den Augen...",
  nameExampleHero: "Alice Fordring",
  nameExampleCharacter: "Valerie Maroto",
};
...
const ZH: SettingsText = {
  ...
  modelFolderOpenedAt: "已打开模型文件夹：{path}",
  clipNotPlayed: "音频片段未能播放：{reason}",
  narratorTimedOut: "叙述者响应太久。模型可能仍在后台运行；稍等片刻后重试，若系统负载过高，请重启本地模型。",
  portraitOf: "{name}（肖像）",
  emptyStoryHint: "开始故事并描述你在做什么——接下来由叙述者接手，场景和其余一切都交给它。",
  whatDoYouDo: "你要做什么？",
  createNewStory: "创建新故事",
  fill: "填写",
  add: "添加",
  auto: "自动",
  willBeRemovedFromStory: "{name} 将从这个故事中移除。",
  builtInModel: "内置模型",
  localModelUnavailable: "内置模型没有响应。请确认已下载，然后重新启动游戏。",
  localModelMissing: "模型尚未下载。请在磁盘数据面板中获取。",
  quickFill: "快速填写",
  serverUrl: "服务器 URL",
  model: "模型",
  enteredManually: "（手动）",
  modelListFailed: "无法从服务器获取模型列表——请手动输入 id。",
  apiKey: "API 密钥",
  customServerNote: "任何兼容 OpenAI 的服务器：llama.cpp、LM Studio、vLLM、TabbyAPI、KoboldCpp、OpenRouter 或远程 Ollama。一切都留在你的电脑上，大多数本地服务器无需密钥。使用 OpenRouter 时，请从这里粘贴模型 id：",
  speechRateNote: "适用于任何声音——本地或云端：速度由播放器控制，音调不变。",
  voiceInput: "语音输入",
  noAchievementsYet: "暂时还没有。成就来自行动——面对最强者屹立不倒、饶恕败者、不出一击度过一幕。成就不是求来的，它们自然发生。",
  xpReward: "+{n} 经验",
  from: "来自：",
  reward: "奖励：",
  item: "物品",
  computesOn: "运行于：",
  check: "检查",
  deleteAllLocalData: "删除所有本地数据",
  supportBlurb: "Dungeon Ultimate 是 Nerual Dreming 与 Neuro-Soft 的免费开源项目。如果它在你的电脑上找到了一席之地，你的支持将帮助我们打造新的便携神经网络。",
  madeBy: "作者：",
  founderOf: "——创始人：",
  neuroSoft: "Neuro-Soft",
  clearLocalDataWarning: "将从这台电脑上删除所有本地故事、消息、角色、上传的照片、生成的图片和临时参考文件。",
  chatWillBeDeleted: "{title} 及其已保存的消息将从本地数据库中删除。",
  charactersTab: "角色",
  dataTab: "数据",
  customWorldPlaceholder: "你是海岸灯塔的守塔人，这里的雾开始低声回应。昨夜，灯光自己熄灭了……",
  openingPlaceholder: "雨点敲打着公交候车亭的铁皮顶。你裹紧外套，又看了一眼时间。11:40 那班车已经晚了二十分钟，而这里唯一的另一个人一直盯着你……",
  nameExampleHero: "艾丽丝·福德林",
  nameExampleCharacter: "瓦莱丽·马罗托",
};
...
const JA: SettingsText = {
  ...
  modelFolderOpenedAt: "モデルのフォルダを開きました：{path}",
  clipNotPlayed: "クリップを再生できませんでした：{reason}",
  narratorTimedOut: "語り手の応答に時間がかかりすぎました。モデルはまだバックグラウンドで動作している可能性があります。少し待ってから再試行するか、システムの負荷が高い場合はローカルモデルを再起動してください。",
  portraitOf: "{name}（肖像）",
  emptyStoryHint: "物語を始めて、自分が何をするか書いてください。あとは語り手が場面もろとも引き継ぎます。",
  whatDoYouDo: "どうしますか？",
  createNewStory: "新しい物語を作る",
  fill: "入力",
  add: "追加",
  auto: "自動",
  willBeRemovedFromStory: "{name} はこの物語から削除されます。",
  builtInModel: "内蔵モデル",
  localModelUnavailable: "内蔵モデルが応答しません。ダウンロード済みか確認し、ゲームを再起動してください。",
  localModelMissing: "モデルがダウンロードされていません。ディスク上のデータのパネルから取得してください。",
  quickFill: "クイック入力",
  serverUrl: "サーバー URL",
  model: "モデル",
  enteredManually: "（手動）",
  modelListFailed: "サーバーからモデル一覧を取得できませんでした。id を手入力してください。",
  apiKey: "API キー",
  customServerNote: "OpenAI 互換のサーバーなら何でも：llama.cpp、LM Studio、vLLM、TabbyAPI、KoboldCpp、OpenRouter、リモートの Ollama。すべてあなたのマシン内で完結し、ほとんどのローカルサーバーにキーは不要です。OpenRouter の場合はこちらからモデル id を貼り付けてください：",
  speechRateNote: "ローカルでもクラウドでも、どの声にも効きます。速さはプレイヤー側で決まり、音の高さは変わりません。",
  voiceInput: "音声入力",
  noAchievementsYet: "まだありません。実績は行いによって得られます。最強の敵に立ち向かう、敗者を見逃す、一撃も交えずに場面を切り抜ける。願って得るものではなく、起こるものです。",
  xpReward: "+{n} 経験値",
  from: "依頼主：",
  reward: "報酬：",
  item: "アイテム",
  computesOn: "処理先：",
  check: "確認",
  deleteAllLocalData: "ローカルデータをすべて削除",
  supportBlurb: "Dungeon Ultimate は Nerual Dreming と Neuro-Soft による無料のオープンソースプロジェクトです。あなたのマシンに居場所を見つけたなら、ご支援は新しいポータブルなニューラルネットの制作に役立ちます。",
  madeBy: "制作：",
  founderOf: "— 創設者：",
  neuroSoft: "Neuro-Soft",
  clearLocalDataWarning: "このコンピューターからローカルの物語、メッセージ、キャラクター、アップロードした写真、生成画像、一時的な参照ファイルをすべて削除します。",
  chatWillBeDeleted: "{title} と保存されたメッセージはローカルのデータベースから削除されます。",
  charactersTab: "キャラクター",
  dataTab: "データ",
  customWorldPlaceholder: "あなたは霧がささやき返すようになった海岸の灯台守。昨夜、灯りはひとりでに消えた……",
  openingPlaceholder: "雨がバス停のトタン屋根を叩く。コートの前を合わせ、もう一度時計を見る。11時40分の便は二十分遅れ、ここにいるもう一人の人物はずっとこちらを見ている……",
  nameExampleHero: "アリス・フォードリング",
  nameExampleCharacter: "ヴァレリー・マロト",
};
